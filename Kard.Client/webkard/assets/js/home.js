    ...
    homeCover: function () {
        ...
        var helper = new httpHelper({
            ...
            success: function (data) {
                ...
                $(".bg-layer").css("background-image", "linear-gradient(to bottom, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.3) 100%),url(" + imageUrl + "/" + (data.media.cdnPath + "." + data.media.mediaExtension || "") + ")").fadeIn("slow");
