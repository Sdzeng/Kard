...
namespace Kard.Module
{
    ...
    /// </summary>
    internal class KardModuleCollection : List<KardModuleInfo>
    {
        public Type StartupModuleType { get; }

        public KardModuleCollection(Type startupModuleType)
        {
        ...
        public TModule GetModule<TModule>() where TModule : KardModule
        {
            var module = this.FirstOrDefault(m => m.Type == typeof(TModule));
            if (module == null)
            {
                throw new KardException("Can not find module for " + typeof(TModule).FullName);
            }
        ...
        public List<KardModuleInfo> GetSortedModuleListByDependency()
        {
        ...
        public static void EnsureKernelModuleToBeFirst(List<KardModuleInfo> modules)
        {
            var kernelModuleIndex = modules.FindIndex(m => m.Type == typeof(KardKernelModule));
        ...
        public static void EnsureStartupModuleToBeLast(List<KardModuleInfo> modules, Type startupModuleType)
        {
